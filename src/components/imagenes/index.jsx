...
const CameraCapture = () => {
  ...
  return (
    <div>
      <h1>Capturar Foto con React</h1>
      {/* Elemento de video donde se mostrará la transmisión de la cámara */}
      ...
      {capturedImage && (
        <div>
          ...
          <a href={capturedImage} download="captured_image.png">Descargar Imagen</a>
        </div>
      )}
    </div>
  );
