...
const transformData = (formData, profesorID) => {
    ...
    return {
        ...
        profesorID: profesorID, // Agregando el profesorID
        horarios: horarios,
    };
};
...
export default function NuevaMateriaDialog({ open, onClose }) {
    ...
    const [isDirty, setIsDirty] = useState(false); // Estado para verificar si el formulario ha sido modificado
    ...
    const {
        ...
        error,
        errorResponse,
        resetForm // Añade una función para restablecer el formulario
    } = useFormPost(
        initialValues,
        requiredFields,
        ...
        'POST',
        headers,
        (formData) => transformData(formData, authData.user.id)
    );
